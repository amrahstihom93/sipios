...
# The program files called can be found in ~/update/sipios/backup
...
#	This program runs various update programs for Sipi OS for Robots, from Sigmaway.
#	See more about Sigmaway at http://www.gosigmaway.com
'''
...
class MainPanel(wx.Panel):
	...
	def __init__(self, parent):
		...
		wx.StaticText(self, -1, "Sipi OS For Robotics Backup", (25, 5))					# (Minus 50, minus 0)
	...
	def OnEraseBackground(self, evt):
		...
		robot = "/home/pi/update/sipios/update_gui_elements/sig.png"
	...
	def backup(self, event):
		...
		if dlg.ShowModal() == wx.ID_OK:
			start_command = "sudo sh /home/pi/update/sipios/backup/call_backup.sh"
	...
	def restore(self, event):
		...
		ran_dialog = False
		if dlg.ShowModal() == wx.ID_OK:
			start_command = "sudo sh /home/pi/update/sipios/backup/call_restore.sh"
			send_bash_command_in_background(start_command)
