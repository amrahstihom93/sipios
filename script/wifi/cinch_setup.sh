...
# 1).  Adhoc is wifi, open.  SSID is "si"
# 2).  Connect and should get an IP address.
# 3).  Type in "sig.local" in browser.
...
cd ~
wget https://github.com/SigmawayLLC/RTL8188-hostapd/archive/v2.0.tar.gz
...
sudo bash /home/pi/si_update/sipios/Troubleshooting_GUI/wifi_debug/setup_wifi_debug.sh